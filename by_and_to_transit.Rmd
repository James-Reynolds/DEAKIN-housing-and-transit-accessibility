...
victoria_gtfs <- tidytransit::read_gtfs("data/victoria_gtfs_duplicates_removed.zip")

list_gtfs = gtfssupplyindex:::gtfs_by_route_type("data/victoria_gtfs.zip")
...
si_by_route_type <- si_calc(
 list_gtfs = list_gtfs,
 stops_in_or_near_areas = stops_in_or_near_areas, 
 date_ymd = lubridate::ymd("2023-04-27"), 
 verbose = TRUE)

Victoria_total_SI_SA1_230427_recreated_dataset <- si_total(si_by_route_type)
